  ...
  function InputsSearch(obj, settings) {
    ...
    this.create = function() {
      var $search = $('<input />', {
            ...
            'data-dynatable-query': 'search', 'class':'form-control',
  ...
  function PaginationPerPage(obj, settings) {
    ...
    this.create = function() {
      var $select = $('<select>', {
            ...
            'style': ' display:inline;height: 40px; width: 70px'
          });
      ...
      return $('<span />', {
        'class': 'dynatable-per-page form-inline',
        'style': 'float:right; margin-bottom:5px; display:inline; ',
